...
- (void)show{
    ...
    self.remindersLabel.textColor = cLabelColor;
    ...
    self.remindersView.backgroundColor = cSecondaryBG;
    ...
    self.remindersContent.textColor = cLabelColor;
    ...
    self.EventLabel.textColor = cLabelColor;
    ...
    self.EventView.backgroundColor = cSecondaryBG;
    ...
    self.EventContent.textColor = cLabelColor;
