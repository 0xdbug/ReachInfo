...
-(void)show{
    ...
    cmdLabel.textColor = [UIColor labelColor];
    ...
    cmdLabel.center = CGPointMake(self.superview.center.x + 20, 49);
    cmdLabel.layer.shadowColor = [[UIColor labelColor] CGColor];
    ...
    upLabel.center = CGPointMake(self.superview.center.x + 20, 69);
    ...
    upLabel.layer.shadowColor = [[UIColor labelColor] CGColor];
    ...
    timeLabel.center = CGPointMake(self.superview.center.x + 20, 89);
    ...
    timeLabel.layer.shadowColor = [[UIColor labelColor] CGColor];
    ...
    dateLabel.center = CGPointMake(self.superview.center.x + 20, 109);
    ...
    dateLabel.layer.shadowColor = [[UIColor labelColor] CGColor];
    ...
    battLabel.textColor = [UIColor labelColor];
    battLabel.font = [UIFont fontWithName:@"Menlo" size:dF];
    battLabel.adjustsFontSizeToFitWidth = true;
    battLabel.center = CGPointMake(self.superview.center.x + 20, 129);
    ...
    battLabel.layer.shadowColor = [[UIColor labelColor] CGColor];
    ...
    IPLabel.center = CGPointMake(self.superview.center.x + 20, 149);
    ...
    IPLabel.layer.shadowColor = [[UIColor labelColor] CGColor];
    ...
    returnLabel.textColor = [UIColor labelColor];
    ...
    returnLabel.center = CGPointMake(self.superview.center.x + 20, 169);
    returnLabel.layer.shadowColor = [[UIColor labelColor] CGColor];
